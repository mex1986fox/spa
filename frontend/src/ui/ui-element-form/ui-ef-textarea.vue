<template>
  <div class="ui-ef-textarea" @click="isClick()">
    <span
      class="ui-ef-textarea__caption"
      :class="{'ui-ef-textarea__caption_active':modFocus, 
                   'ui-ef-textarea__caption_completed':modCompleted,
                   'ui-ef-textarea__caption_disabled':dDisabled}"
      @click="isClick()"
    >{{dCaption}}</span>
    <textarea
      class="ui-ef-textarea__input"
      :class="{'ui-ef-textarea__input_active':modFocus,
                   'ui-ef-textarea__input_disabled':dDisabled}"
      ref="textarea"
      @focus="isFocus()"
      @blur="isBlur()"
      @input="isInputText()"
    ...
    ></textarea>
    <hr
      class="ui-ef-textarea__border"
      :class="{'ui-ef-textarea__border_active':modFocus,
                  'ui-ef-textarea__border_disabled':dDisabled}"
    >
    <span
      class="ui-ef-textarea__help"
      :class="{'ui-ef-textarea__help_active':dHelp,
                    'ui-ef-textarea__help_disabled':dDisabled}"
      @click="isClick()"
    >{{dHelp}}</span>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    isAutoresize() {
      ...
      if (this.height == undefined && this.autoresize != undefined && this.dValue == "") {
