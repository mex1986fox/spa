<template>
  <lt-main>
    <div class="lt-main__content">
      ...
      <lt-main-menu>
        <div class="lt-main-menu__header">Мои товары и услуги</div>
      </lt-main-menu>

      <div class="pg-myshop__content">
        <h2 class="ui-header ui-header_2 ui-header_white" v-if="loadingCatalogs==false">
          Каталог
        ...
        <div class="row" v-if="loadingCatalogs==false && dCatalogs.length<=0">
          <div class="col_4 col-phone_6">
            <p class="ui-header ui-header_white ui_header_h3">Создайте каталог товаров и услуг!</p>
            <input
              type="button"
        ...
        <wg-tabs-catalog v-if="dCatalogs.length>0" :catalogs="dCatalogs" @onFocus="isFocusProduct"/>
