      ...
      <ui-menu :show="showMenu"
        ...
        <ul class="ui-menu__ul">
          <li class="ui-menu__li"
              @click="isCheckMain(keyPhoto)">Сделать главной</li>
          <li class="ui-menu__li"
              @click="isDeletePhoto(keyPhoto)">Удалить</li>
        </ul>
      </ui-menu>
    </div>
    <div v-if="showSpinner==true"
         class="wg-form-registration__card-img-spinner">
